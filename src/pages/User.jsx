      ...
      <div className='w-full mx-auto lg:w-10/12'>
        <div className='mb-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 mb-8 md:gap-8'>
            <div className='relative custom-card-image mb-6 md:mb-0'>
              <div className='rounded-lg shadow-xl card image-full'>
                <figure>
                  <img src={avatar_url} alt={`${name} profile picture`} />
                </figure>
                <div className='card-body justify-end'>
                  <h2 className='card-title mb-0 absolute bottom-12 text-white left-10'>
                    {name}
                  </h2>
                  <p className='absolute bottom-6 text-white left-10'>
                    {login}
                  </p>
                </div>
              </div>
